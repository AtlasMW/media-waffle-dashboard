...
function renderROIContent(tab, m, l, pm, pl, numMonths) {
  ...
  var ltvDescription = metaData.ltvDescription || (hasLTV ? 'Currently estimated at ~$'+clientLTV+' per client.' : 'Not yet determined for this client.');
