import{w as d,r as o,c as s}from"./chunk-EPOLDU6W-Dso2WXXj.js";import{j as e}from"./jsx-runtime-u17CrQMm.js";const i=`
:root {
...
`,m=d(function(){const a=o.useRef(!1),n=s("routes/_app");return o.useEffect(()=>{if(a.current)return;a.current=!0,n?.profile?.client_slug&&(window.__CLIENT_SLUG__=n.profile.client_slug);const t=setInterval(()=>{if(typeof window.Chart<"u"){clearInterval(t);const r=document.createElement("script");r.textContent=l,document.body.appendChild(r)}},100);return()=>clearInterval(t)},[]),e.jsxs(e.Fragment,{children:[e.jsx("style",{dangerouslySetInnerHTML:{__html:i}}),e.jsxs("aside",{className:"sidebar",children:[e.jsxs("div",{className:"sidebar-logo",children:[e.jsx("div",{className:"logo-text",children:"Media Waffle"}),e.jsx("div",{className:"logo-sub",children:"Client Dashboard"})]}),e.jsxs("nav",{className:"sidebar-nav",children:[e.jsx("div",{className:"nav-label",children:"Reporting"}),e.jsxs("div",{className:"nav-item active",onClick:t=>window._dashboardSwitchTab?.("overview",t.currentTarget),children:[e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("rect",{x:"3",y:"3",width:"7",height:"7",rx:"1"}),e.jsx("rect",{x:"14",y:"3",width:"7",height:"7",rx:"1"}),e.jsx("rect",{x:"3",y:"14",width:"7",height:"7",rx:"1"}),e.jsx("rect",{x:"14",y:"14",width:"7",height:"7",rx:"1"})]}),"Overview"]}),e.jsxs("div",{className:"nav-item",onClick:t=>window._dashboardSwitchTab?.("ads",t.currentTarget),children:[e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("path",{d:"M12 20V10"}),e.jsx("path",{d:"M18 20V4"}),e.jsx("path",{d:"M6 20v-4"})]}),"Ad Performance"]}),e.jsxs("div",{className:"nav-item",onClick:t=>window._dashboardSwitchTab?.("leads",t.currentTarget),children:[e.jsxs("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"}),e.jsx("circle",{cx:"9",cy:"7",r:"4"}),e.jsx("path",{d:"M22 21v-2a4 4 0 0 0-3-3.87"}),e.jsx("path",{d:"M16 3.13a4 4 0 0 1 0 7.75"})]}),"Lead Data"]}),e.jsxs("div",{className:"nav-item",onClick:t=>window._dashboardSwitchTab?.("roi",t.currentTarget),children:[e.jsx("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:e.jsx("path",{d:"M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"})}),"ROI"]})]}),e.jsxs("div",{className:"sidebar-footer",children:[e.jsx("div",{className:"sidebar-client",id:"sidebar-client",children:"Loading..."}),e.jsx("div",{className:"sidebar-updated",id:"sidebar-updated",children:"Last updated: --"})]})]}),e.jsxs("div",{className:"main",children:[e.jsxs("div",{className:"mobile-tabs",id:"mobile-tabs",children:[e.jsx("button",{className:"mobile-tab active",onClick:t=>{window._dashboardSwitchTab?.("overview",document.querySelector(".nav-item:nth-child(2)")),window._dashboardSetMobileTab?.(t.currentTarget)},children:"Overview"}),e.jsx("button",{className:"mobile-tab",onClick:t=>{window._dashboardSwitchTab?.("ads",document.querySelector(".nav-item:nth-child(3)")),window._dashboardSetMobileTab?.(t.currentTarget)},children:"Ads"}),e.jsx("button",{className:"mobile-tab",onClick:t=>{window._dashboardSwitchTab?.("leads",document.querySelector(".nav-item:nth-child(4)")),window._dashboardSetMobileTab?.(t.currentTarget)},children:"Leads"}),e.jsx("button",{className:"mobile-tab",onClick:t=>{window._dashboardSwitchTab?.("roi",document.querySelector(".nav-item:nth-child(5)")),window._dashboardSetMobileTab?.(t.currentTarget)},children:"ROI"})]}),e.jsxs("div",{className:"topbar",children:[e.jsxs("div",{className:"topbar-left",children:[e.jsx("h1",{id:"client-name",children:"Loading..."}),e.jsx("p",{id:"range-subtitle",children:"Performance Dashboard"})]}),e.jsxs("div",{className:"topbar-right",children:[e.jsxs("div",{className:"month-selector",id:"month-selector-wrap",children:[e.jsx("button",{className:"month-nav-btn",id:"month-prev",onClick:()=>window._dashboardNavMonth?.(-1),children:"←"}),e.jsx("select",{id:"month-selector",onChange:()=>window._dashboardChangeMonth?.()}),e.jsx("button",{className:"month-nav-btn",id:"month-next",onClick:()=>window._dashboardNavMonth?.(1),children:"→"})]}),e.jsx("span",{id:"range-date-label",style:{fontSize:"12px",color:"#8a8478",marginRight:"10px",display:"none"}}),e.jsxs("div",{className:"date-selector",children:[e.jsx("button",{className:"date-btn",onClick:t=>window._dashboardSetRange?.("90d",t.currentTarget),children:"90D"}),e.jsx("button",{className:"date-btn active",onClick:t=>window._dashboardSetRange?.("monthly",t.currentTarget),children:"Monthly"}),e.jsxs("div",{className:"custom-range-wrap",children:[e.jsx("button",{className:"date-btn",id:"custom-range-btn",onClick:t=>window._dashboardToggleCustomRange?.(t.currentTarget),children:"Custom"}),e.jsxs("div",{className:"custom-range-popup",id:"custom-range-popup",children:[e.jsx("label",{children:"From"}),e.jsx("input",{type:"date",id:"custom-start"}),e.jsx("label",{children:"To"}),e.jsx("input",{type:"date",id:"custom-end"}),e.jsx("button",{className:"apply-btn",onClick:()=>window._dashboardApplyCustomRange?.(),children:"Apply"})]})]})]}),e.jsxs("button",{className:"export-btn",onClick:()=>window._dashboardExportPDF?.(),children:[e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),e.jsx("polyline",{points:"7 10 12 15 17 10"}),e.jsx("line",{x1:"12",y1:"15",x2:"12",y2:"3"})]}),"Export PDF"]})]})]}),e.jsxs("div",{className:"content",id:"dashboard-content",children:[e.jsx("div",{className:"tab-content active",id:"tab-overview"}),e.jsx("div",{className:"tab-content",id:"tab-ads"}),e.jsx("div",{className:"tab-content",id:"tab-leads"}),e.jsx("div",{className:"tab-content",id:"tab-roi"})]})]})]})});export{m as default};
